...
test_that("it returns the values supplied", {
  iccin <- iccInput(1:3)
  out <- sapply(1:3, function(x)iccin())
  expect_equal(out, 1:3)
})

test_that("it loops values", {
  iccin <- iccInput(1:3, loop = TRUE)
  out <- sapply(1:4, function(x)iccin())
  expect_equal(out, c(1:3, 1))
})
...
test_that("comparators", {
  ...
  runIntCodeComputer(prog1, iccin = function()7, iccout = test_output_is(0))
  runIntCodeComputer(prog1, iccin = function()8, iccout = test_output_is(1))

  # Using position mode, consider whether the input is less than 8;
  # output 1 (if it is) or 0 (if it is not).
  prog2 <- c(3,9,7,9,10,9,4,9,99,-1,8)

  runIntCodeComputer(prog2, iccin = function()7, iccout = test_output_is(1))
  runIntCodeComputer(prog2, iccin = function()8, iccout = test_output_is(0))
  runIntCodeComputer(prog2, iccin = function()9, iccout = test_output_is(0))

  # Using immediate mode, consider whether the input is equal to 8;
  # output 1 (if it is) or 0 (if it is not).
  prog3 <- c(3,3,1108,-1,8,3,4,3,99)

  runIntCodeComputer(prog3, iccin = function()7, iccout = test_output_is(0))
  runIntCodeComputer(prog3, iccin = function()8, iccout = test_output_is(1))

  # Using position mode, consider whether the input is less than 8;
  # output 1 (if it is) or 0 (if it is not).
  prog4 <- c(3,9,7,9,10,9,4,9,99,-1,8)

  runIntCodeComputer(prog4, iccin = function()7, iccout = test_output_is(1))
  runIntCodeComputer(prog4, iccin = function()8, iccout = test_output_is(0))
  runIntCodeComputer(prog4, iccin = function()9, iccout = test_output_is(0))
})
...
test_that("jumps", {
  ...
  runIntCodeComputer(prog1, iccin = function()0, iccout = test_output_is(0))
  runIntCodeComputer(prog1, iccin = function()1337, iccout = test_output_is(1))

  prog2 <- c(3,3,1105,-1,9,1101,0,0,12,4,12,99,1) # (using immediate mode)

  runIntCodeComputer(prog2, iccin = function()0, iccout = test_output_is(0))
  runIntCodeComputer(prog2, iccin = function()1337, iccout = test_output_is(1))
})
...
test_that("day 6", {
  ...
  runIntCodeComputer(prog, iccin = function()7, iccout = test_output_is(999))
  runIntCodeComputer(prog, iccin = function()8, iccout = test_output_is(1000))
  runIntCodeComputer(prog, iccin = function()9, iccout = test_output_is(1001))
})
